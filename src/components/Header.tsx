...
export default function Header() {
  ...
  return (
    <header className="relative z-10 pb-6 mb-8 border-b border-white/10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:items-end gap-1 font-mono text-[10px] text-stone-400">
          <div className="px-3 py-1 bg-white/5 border border-white/10 backdrop-blur-md rounded-full flex items-center gap-1.5 self-start sm:self-auto">
            ...
            <span>Created by Ella Adams & Assistant</span>
          </div>
        </div>
      </div>
    </header>
